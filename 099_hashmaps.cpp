...
// HashMaps have a load factor (n/b), where b=>bucket size, which should be kept below 0.7 for hassle free hashing. If n (no. of inputs) increases, then the size of the bucket is also increased (doubled, usually) to adjust the load factor.